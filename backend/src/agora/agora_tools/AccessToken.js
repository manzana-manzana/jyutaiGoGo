...
class AccessToken {
  ...
  from_string(origin_token) {
    ...
    for (let i = 0; i < service_count; i++) {
      ...
      let service = new AccessToken.kServices[service_type]()
...
AccessToken.kServices = {}
AccessToken.kServices[kApaasServiceType] = ServiceApaas
AccessToken.kServices[kChatServiceType] = ServiceChat
AccessToken.kServices[kFpaServiceType] = ServiceFpa
AccessToken.kServices[kRtcServiceType] = ServiceRtc
AccessToken.kServices[kRtmServiceType] = ServiceRtm
